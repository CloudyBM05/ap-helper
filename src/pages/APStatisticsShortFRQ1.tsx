...
const PDF = '/APSTAT-ShortFRQ1.pdf';

const aiPrompt = `STRICT AI PROMPT (TOKEN-EFFICIENT, GRADER-FRIENDLY):\nYou are a strict AP Statistics grader. Evaluate each part of the 2025 AP Statistics FRQ below.\nFormat BE STRICT:\n\nLabel each part (A, B, C(i), C(ii))\n\nOutput score as “1/1” or “0/1”\n\nGive brief, justification-based explanation only if needed to understand the score (max 2 lines).\n\nUse minimal words. No restating questions. No intros or conclusions. Do not explain grading logic. Assume the boxplots are visible.\n\nQuestion Content (Summary for Model):\n100 random cars from Country A and B. Boxplots of mpg shown.\nTasks:\nA. Compare gas mileage distributions.\nB. For Country A, is mean <, >, or = 18 mpg? Justify.\nC(i). Find combined range. Justify.\nC(ii). Give a possible combined median. Justify with boxplots.`;

const APStatisticsShortFRQ1: React.FC = () => {
        ...
        <div className="flex flex-col md:flex-row justify-center items-start gap-8">
          ...
          <div className="flex-[1.5] min-w-[400px] max-w-5xl bg-white shadow-lg p-6 flex flex-col rounded-2xl border border-purple-100">
            <h2 className="text-xl font-bold mb-4 text-center text-purple-700">
              2025 Collegeboard Short FRQ Set 1 - Question 1
            </h2>
            <iframe
              src={PDF}
              title="AP Statistics Short FRQ #1 PDF"
