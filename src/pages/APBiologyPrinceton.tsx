...
// AP Biology Princeton Exam PDF
const PDF_URL = `${import.meta.env.BASE_URL}APBio-Exam2.pdf`;
const NUM_QUESTIONS = 40;
const CHOICES = ['A', 'B', 'C', 'D', 'E'];

// Answer key provided by user (Q1 - Q40)
...
const APBiologyPrinceton: React.FC = () => {
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-slate-100 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-extrabold text-emerald-800 tracking-tight">AP Biology — Princeton MCQ Exam</h1>
        ...
        <div className="mt-8 w-full flex flex-col md:flex-row gap-8 justify-start items-start">
          <div className="flex-[3] min-w-[450px] max-w-5xl bg-white shadow-xl rounded-2xl flex flex-col items-center border border-slate-200">
            <div className="w-full p-4 bg-slate-50 rounded-t-2xl border-b border-slate-200">
              <h2 className="text-xl font-bold text-center text-emerald-700">AP Biology Princeton Exam Document</h2>
            </div>
            <iframe src={PDF_URL} width="100%" height="900px" title="AP Biology Princeton Exam PDF" className="rounded-b-2xl" style={{ border: 'none', minHeight: '800px' }} />
          </div>
                    ...
                    <tr key={qIdx} className="hover:bg-slate-50">
                      ...
                      {submitted && (
                        <td className="text-center font-bold p-2">
                          {answers[qIdx] === CORRECT_ANSWERS[qIdx] ? (<span className="text-green-500">✔</span>) : (<span className="text-red-500">✖</span>)}
                        </td>
                      )}
                    </tr>
                  ))}
...
export default APBiologyPrinceton;
