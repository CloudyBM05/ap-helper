...
const exams = [
  {
    ...
    description: 'Official AP Physics Qualitative/Quantitative Translation FRQ',
    implemented: true
  }
];

const APPhysicsQualitativeQuantitative = () => {
  ...
  return (
    <div className="min-h-screen py-16 px-4 bg-slate-50 flex items-center justify-center">
      <div className="w-full max-w-xl mx-auto flex flex-col items-center justify-center">
        ...
        <h1 className="text-3xl font-bold mb-8 text-center w-full">Select AP Physics Qualitative/Quantitative Translation FRQ</h1>
            ...
            <button
              ...
              onClick={() => {
                if (exam.implemented) {
                  ...
                  navigate('/ap-physics-practice-exam/qualitative-quantitative/q1');
                } else {
...
export default APPhysicsQualitativeQuantitative;