...
const PDF_URL = "/APWorld-Exam4.pdf"; // Cracked AP World Practice Exam 2
const NUM_QUESTIONS = 55;
const CHOICES = ['A', 'B', 'C', 'D'];
// Cracked AP World Exam 2 Answer Key (from user)
...
const APWorldPracticeExamMCQCracked2: React.FC = () => {
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-slate-100 relative">
      <button
        onClick={() => navigate(-1)}
        className="absolute top-4 left-4 px-4 py-2 bg-white text-green-600 rounded-lg shadow hover:bg-slate-50 transition-colors flex items-center gap-2 z-10"
      >
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold text-green-800 tracking-tight">AP World Cracked MCQ Practice Exam 2</h1>
        ...
        <div className="mt-8 w-full flex flex-col md:flex-row gap-8 justify-start items-start">
          ...
          <div className="flex-[3] min-w-[450px] max-w-5xl bg-white shadow-xl rounded-2xl flex flex-col items-center border border-slate-200">
            <div className="w-full p-4 bg-slate-50 rounded-t-2xl border-b border-slate-200">
                <h2 className="text-xl font-bold text-center text-green-700">Cracked AP World Practice Exam 2 Document</h2>
            </div>
            <iframe
              src={PDF_URL}
              width="100%"
              height="900px"
              title="AP World Cracked Practice Exam 2 PDF"
          ...
          <div className="flex-1 min-w-[400px] max-w-md bg-white shadow-xl p-6 rounded-2xl border border-slate-200 self-stretch">
            <div className="p-4 bg-slate-50 rounded-t-xl border-b border-slate-200 -m-6 mb-6">
                <h2 className="text-2xl font-bold mb-1 text-center text-green-800">Digital Scantron</h2>
            </div>
            {!submitted && (
              <div className="text-center">
                <button
                  className="mb-4 w-full px-6 py-3 bg-green-600 text-white text-lg rounded-lg font-semibold shadow-md hover:bg-green-700 transition-transform transform hover:scale-105"
...
export default APWorldPracticeExamMCQCracked2;
