...
const PDF_URL = 'https://marcolearning.com/wp-content/uploads/2023/09/Marco-APUSGOV-FPT-09-07-23.pdf';
const EXPLANATION_URL = 'https://marcolearning.com/wp-content/uploads/2023/09/Marco-APUSGOV-FPT-Explanations-09-07-23.pdf';
...
const APGovPracticeExamMarco: React.FC = () => {
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-slate-100 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold text-slate-800 tracking-tight">Marco-AP Gov Practice Exam</h1>
            <p className="mt-2 text-lg text-slate-600">55 Questions | 80 Minutes</p>
        </div>
        ...
        <div className="mt-8 w-full flex flex-col md:flex-row gap-8 justify-center items-start">
          {/* PDF Link Section */}
          {showPdf && (
            <div className="flex-1 min-w-[400px] max-w-md bg-white shadow-xl p-6 rounded-2xl border border-slate-200 self-stretch mb-8 md:mb-0">
...
export default APGovPracticeExamMarco;
