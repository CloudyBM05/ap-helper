...
const spatialSets = [
  {
    ...
    description:
      'Official AP Human Geography Spatial Relationships & Data Interpretation, 2025, Set 1. Practice with real exam-style free response questions. Written parts are AI-graded.',
  },
  {
    id: 'set2',
    label: 'Collegeboard 2025 Set 2',
    description:
      'Official AP Human Geography Spatial Relationships & Data Interpretation, 2025, Set 2. Practice with real exam-style free response questions. Written parts are AI-graded.',
  },
];

const APHumanGeographySpatialRelationshipsSelect = () => {
    ...
    <div className='min-h-screen py-16 px-4 bg-slate-50 flex items-center justify-center'>
      <div className='w-full max-w-xl mx-auto flex flex-col items-center justify-center'>
        ...
        <h1 className='text-3xl font-bold mb-8 text-center w-full text-emerald-700'>
          Select AP Human Geography Spatial Relationships Set
        </h1>
        <div className='grid grid-cols-1 gap-6 w-full'>
          {spatialSets.map((set) => (
            <button
              key={set.id}
              onClick={() => navigate(`/ap-human-geography-practice-exam/spatial-relationships/${set.id}`)}
...
export default APHumanGeographySpatialRelationshipsSelect;
