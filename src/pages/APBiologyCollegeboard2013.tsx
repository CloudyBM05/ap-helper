...
// AP Biology Collegeboard 2013 Exam PDF
const PDF_URL = `${import.meta.env.BASE_URL}APBio-Exam1.pdf`;
const NUM_QUESTIONS = 53;
const CHOICES = ['A', 'B', 'C', 'D'];

// AP Biology Collegeboard 2013 Answer Key (Questions 1-53)
...
const APBiologyCollegeboard2013: React.FC = () => {
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-slate-100 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold text-emerald-800 tracking-tight">AP Biology Collegeboard 2013 MCQ Exam</h1>
        ...
        <div className="mt-8 w-full flex flex-col md:flex-row gap-8 justify-start items-start">
          ...
          <div className="flex-[3] min-w-[450px] max-w-5xl bg-white shadow-xl rounded-2xl flex flex-col items-center border border-slate-200">
            <div className="w-full p-4 bg-slate-50 rounded-t-2xl border-b border-slate-200">
                <h2 className="text-xl font-bold text-center text-emerald-700">AP Biology 2013 Exam Document</h2>
            </div>
            <iframe
              src={PDF_URL}
              width="100%"
              height="900px"
              title="AP Biology 2013 Exam PDF"
          ...
          <div className="flex-1 min-w-[400px] max-w-md bg-white shadow-xl p-6 rounded-2xl border border-slate-200 self-stretch">
            ...
            <div className="text-sm text-slate-500 mb-4 text-center w-full">
              <span>Left-click to select. Right-click to cross out.</span>
            </div>
...
export default APBiologyCollegeboard2013;
