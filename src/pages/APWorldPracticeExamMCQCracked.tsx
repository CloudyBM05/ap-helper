...
const PDF_URL = "/APWorld-Exam3.pdf"; // Cracked AP World Practice Exam 1
const NUM_QUESTIONS = 55;
const CHOICES = ['A', 'B', 'C', 'D'];
// Cracked AP World Exam 1 Answer Key (from user)
...
const APWorldPracticeExamMCQCracked: React.FC = () => {
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-slate-100 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold text-green-800 tracking-tight">AP World Cracked MCQ Practice Exam 1</h1>
        ...
        <div className="mt-8 w-full flex flex-col md:flex-row gap-8 justify-start items-start">
          ...
          <div className="flex-[3] min-w-[450px] max-w-5xl bg-white shadow-xl rounded-2xl flex flex-col items-center border border-slate-200">
            <div className="w-full p-4 bg-slate-50 rounded-t-2xl border-b border-slate-200">
                <h2 className="text-xl font-bold text-center text-green-700">Cracked AP World Practice Exam 1 Document</h2>
            </div>
            <iframe
              src={PDF_URL}
              width="100%"
              height="900px"
              title="AP World Cracked Practice Exam 1 PDF"
...
export default APWorldPracticeExamMCQCracked;
