...
const PDF = '/APPhysics-QT.pdf';
const PARTS = [
  { id: 'A', label: 'Part A - Compare a₁ and a₂' },
  { id: 'B', label: 'Part B - Derivation' },
  { id: 'C', label: 'Part C - Consistency check' }
];

const ANSWER_KEY = {
  'A': `Compare a₁ and a₂: a₂ > a₁.
Reason: Saltwater has greater density, so buoyant force is larger → net force greater → larger acceleration.`,
  'B': `Derivation:
Newton's 2nd law:
∑Fᵧ = B - mg = ma
Buoyant force B = ρfVg

ρfVg - mg = ma
a = (ρfVg - mg)/m`,
  'C': `Consistency: Yes, because a increases with ρf, matching part A's claim.`
};

const APPhysicsQualitativeQuantitativeQ1 = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          &larr; Back to Qualitative/Quantitative Analysis
        </button>
        <div className="flex flex-col md:flex-row justify-center items-start gap-8">
          ...
          <div className="flex-[2] min-w-[500px] max-w-6xl bg-white shadow-lg p-6 flex flex-col rounded-2xl border border-teal-100">
            <h2 className="text-xl font-bold mb-4 text-center text-teal-700">
              AP Physics Qualitative/Quantitative Analysis - Buoyancy and Acceleration
            </h2>
            <iframe
              src={PDF}
              title="AP Physics Qualitative/Quantitative Analysis"
...
export default APPhysicsQualitativeQuantitativeQ1;
