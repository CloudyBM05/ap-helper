...
const PDF_URL = `${import.meta.env.BASE_URL}APMicro-Exam4.pdf`;
const NUM_QUESTIONS = 60;
const CHOICES = ['A', 'B', 'C', 'D', 'E'];

// Collegeboard 2012 AP Microeconomics MCQ Answer Key
...
const APMicroPracticeExamMCQ2012: React.FC = () => {
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-slate-100 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold text-fuchsia-800 tracking-tight">AP Microeconomics 2012 MCQ Practice Exam</h1>
        ...
        <div className="mt-8 w-full flex flex-col md:flex-row gap-8 justify-start items-start">
          ...
          <div className="flex-[3] min-w-[450px] max-w-5xl bg-white shadow-xl rounded-2xl flex flex-col items-center border border-slate-200">
            <div className="w-full p-4 bg-slate-50 rounded-t-2xl border-b border-slate-200">
                <h2 className="text-xl font-bold text-center text-fuchsia-700">2012 AP Microeconomics Practice Exam Document</h2>
            </div>
            <iframe
              src={PDF_URL}
              width="100%"
              height="900px"
              title="AP Microeconomics 2012 Practice Exam PDF"
...
export default APMicroPracticeExamMCQ2012;
