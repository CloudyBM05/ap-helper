...
const exams = [
  {
    ...
    description: 'Official AP Physics Translation Between Representations FRQ',
    implemented: true
  }
];

const APPhysicsTranslationRepresentations = () => {
...
export default APPhysicsTranslationRepresentations;
