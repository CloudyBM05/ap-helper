...
const exams = [
  {
    ...
    description: 'Official AP Physics Experimental Design FRQ',
    implemented: true
  }
];

const APPhysicsExperimentalDesign = () => {
  ...
  return (
    <div className="min-h-screen py-16 px-4 bg-slate-50 flex items-center justify-center">
      <div className="w-full max-w-xl mx-auto flex flex-col items-center justify-center">
        ...
        <h1 className="text-3xl font-bold mb-8 text-center w-full">Select AP Physics Experimental Design FRQ</h1>
        <div className="grid grid-cols-1 gap-6 w-full">
          {exams.map((exam) => (
            <button
              ...
              onClick={() => {
                if (exam.implemented) {
                  // Navigate to actual FRQ implementation when ready
                  alert(`${exam.label} coming soon!`);
                } else {
...
export default APPhysicsExperimentalDesign;
