...
const PDF_URL = `${import.meta.env.BASE_URL}APPSY-Exam3.pdf`;
const NUM_QUESTIONS = 100;
const CHOICES = ['A', 'B', 'C', 'D', 'E'];

// Princeton Exam 2 AP Psychology MCQ Answer Key
...
const APPsychPracticeExamMCQPrinceton2: React.FC = () => {
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-slate-100 relative">
      <button
        onClick={() => navigate(-1)}
        className="absolute top-4 left-4 px-4 py-2 bg-white text-yellow-600 rounded-lg shadow hover:bg-slate-50 transition-colors flex items-center gap-2 z-10"
      >
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold text-slate-800 tracking-tight">AP Psychology Princeton 2 MCQ Practice Exam</h1>
            <p className="mt-2 text-lg text-slate-600">100 Questions | 70 Minutes</p>
        </div>
        <Stopwatch />
        <div className="mt-8 w-full flex flex-col md:flex-row gap-8 justify-start items-start">
          ...
          <div className="flex-[3] min-w-[450px] max-w-5xl bg-white shadow-xl rounded-2xl flex flex-col items-center border border-slate-200">
            <div className="w-full p-4 bg-slate-50 rounded-t-2xl border-b border-slate-200">
                <h2 className="text-xl font-bold text-center text-slate-700">Princeton 2 AP Psychology Practice Exam Document</h2>
            </div>
            <iframe
              src={PDF_URL}
              width="100%"
              height="900px"
              title="AP Psychology Princeton 2 Practice Exam PDF"
          ...
          <div className="flex-1 min-w-[400px] max-w-md bg-white shadow-xl p-6 rounded-2xl border border-slate-200 self-stretch">
            ...
            {!submitted && (
              <div className="text-center">
                <button
                  className="mb-4 w-full px-6 py-3 bg-yellow-600 text-white text-lg rounded-lg font-semibold shadow-md hover:bg-yellow-700 transition-transform transform hover:scale-105"
...
export default APPsychPracticeExamMCQPrinceton2;
