...
const SocraticChat = () => {
  ...
  const getWelcomeMessage = (course: string, unit: string) => {
    ...
    if (course === 'apphysics1' || course === 'physics1') {
      const unitInfo = getUnitInfo();
      const welcomeMessages = {
        'unit1': "Welcome to AP Physics 1 Unit 1: Kinematics! 📍\n\nI'm your Socratic AI tutor. I'll guide your understanding of motion through inquiry-based learning and problem solving.\n\nKey topics: Position and displacement • Velocity and acceleration • Kinematic equations • Graphical analysis • Projectile motion • Relative motion\n\nWhat interests you about describing motion, or what questions do you have about kinematics?",
        'unit2': "Welcome to AP Physics 1 Unit 2: Dynamics! 💪\n\nI'm your Socratic AI tutor. Let's explore forces and Newton's laws through guided questions and physical reasoning.\n\nKey topics: Newton's three laws • Force types and interactions • Free body diagrams • Force analysis • Applications of Newton's laws\n\nWhat do you want to understand about forces and motion, or what questions do you have about Newton's laws?",
        'unit3': "Welcome to AP Physics 1 Unit 3: Circular Motion and Gravitation! 🌍\n\nI'm your Socratic AI tutor. Let's examine circular motion and universal gravitation through scientific inquiry.\n\nKey topics: Centripetal acceleration • Centripetal force • Universal gravitation • Orbital motion • Gravitational fields\n\nWhat interests you about circular motion and gravity, or what would you like to explore about these fundamental forces?",
        'unit4': "Welcome to AP Physics 1 Unit 4: Energy! ⚡\n\nI'm your Socratic AI tutor. Let's explore work, energy, and conservation through guided problem solving.\n\nKey topics: Work and energy • Kinetic energy • Potential energy • Conservation of energy • Power • Energy transformations\n\nWhat do you want to learn about energy concepts, or what questions do you have about conservation of energy?",
        'unit5': "Welcome to AP Physics 1 Unit 5: Momentum! 🎱\n\nI'm your Socratic AI tutor. Let's examine momentum and collisions through scientific reasoning and analysis.\n\nKey topics: Momentum and impulse • Conservation of momentum • Types of collisions • Center of mass • Momentum in two dimensions\n\nWhat interests you about momentum and collisions, or what collision scenarios would you like to explore?",
        'unit6': "Welcome to AP Physics 1 Unit 6: Simple Harmonic Motion! 🌊\n\nI'm your Socratic AI tutor. Let's explore oscillatory motion and wave behavior through guided inquiry.\n\nKey topics: Hooke's law and springs • Simple harmonic motion • Energy in SHM • Simple pendulums • Wave properties\n\nWhat do you want to understand about oscillations and waves, or what questions do you have about periodic motion?",
        'unit7': "Welcome to AP Physics 1 Unit 7: Torque and Rotational Motion! 🌀\n\nI'm your Socratic AI tutor. Let's examine rotational dynamics and equilibrium through problem-based learning.\n\nKey topics: Angular motion • Torque • Rotational equilibrium • Center of mass • Stability and balance\n\nWhat interests you about rotation and balance, or what would you like to explore about rotational motion?",
        'unit8': "Welcome to AP Physics 1 Unit 8: Fluids! 💧\n\nI'm your Socratic AI tutor. Let's explore fluid mechanics and the behavior of liquids and gases through guided questions.\n\nKey topics: Fluid properties • Pressure in fluids • Buoyancy and floating • Fluid flow principles • Archimedes' principle • Bernoulli's principle\n\nWhat do you want to learn about fluids and their behavior, or what questions do you have about pressure and buoyancy?"
      };
      return welcomeMessages[unit as keyof typeof welcomeMessages] || `Welcome to ${unitInfo.title}! I'm your Socratic AI tutor, ready to help you explore physics through guided questions and scientific inquiry.`;
    }
    if (course === 'apcsp') {
      const unitInfo = getUnitInfo();
      const welcomeMessages = {
