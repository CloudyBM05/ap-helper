...
const FRQ_CONTENT = {
  title: 'Collegeboard 2025 Scale Analysis Set 1',
...
const CRITERIA = [
  'A. Identifies valid culture trait (e.g., food, religion, clothing, language, farming practice).',
  'B. Describes cow\'s milk spatial pattern in Africa from Map 1 (e.g., clustered, dispersed, regional).',
  'C. Compares cow\'s milk vs pork in Asia, using both maps (e.g., pork high east, milk lower overall).',
  'D. Describes one environmental effect of agriculture (e.g., pollution, deforestation, methane, soil degradation).',
  'E. Explains how global ag changes local culture (e.g., food habits, loss of traditional practices).',
  'F. Explains why regions depend on others agriculturally (e.g., trade, climate limits, specialization).',
  'G. Explains spatial diffusion of animals (e.g., relocation diffusion, trade, colonization, migration routes).',
];

const APHumanGeographyScaleAnalysisSet1 = () => {
...
export default APHumanGeographyScaleAnalysisSet1;
