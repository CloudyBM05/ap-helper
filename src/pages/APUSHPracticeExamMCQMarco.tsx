...
const PDF_LINK = "https://marcolearning.com/wp-content/uploads/2019/05/Marco-APUSH-PT.pdf";
const ANSWER_KEY_LINK = "https://marcolearning.com/wp-content/uploads/2019/05/Marco-APUSH-PT1-FPT-Explanations.pdf";

const NUM_QUESTIONS = 55;
const CHOICES = ['A', 'B', 'C', 'D'];

// Correct answer key for the Marco APUSH Exam
const CORRECT_ANSWERS = ["C", "B", "A", "A", "D", "C", "B", "D", "A", "B", "B", "D", "A", "A", "D", "C", "B", "A", "C", "B", "A", "D", "D", "B", "A", "B", "A", "C", "D", "B", "A", "D", "B", "C", "D", "A", "B", "C", "B", "A", "B", "D", "A", "B", "A", "C", "D", "B", "A", "D", "B", "C", "C", "D", "B"];
...
const APUSHPracticeExamMCQMarco: React.FC = () => {
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-slate-100 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold text-slate-800 tracking-tight">Marco-APUSH Practice Exam</h1>
            <p className="mt-2 text-lg text-slate-600">55 Questions | 55 Minutes</p>
        </div>
        <div className="flex justify-center mb-4">
          ...
          >
            {showPdf ? 'Hide' : 'Show'} Exam PDFs
          </button>
        </div>
        <Stopwatch />
        <div className="mt-8 w-full flex flex-col md:flex-row gap-8 justify-center items-start">
          {/* PDF Link Section */}
          {showPdf && (
            <div className="flex-1 min-w-[400px] max-w-md bg-white shadow-xl p-6 rounded-2xl border border-slate-200 self-stretch">
              <div className="p-4 bg-slate-50 rounded-t-xl border-b border-slate-200 -m-6 mb-6">
                  <h2 className="text-2xl font-bold mb-1 text-center text-slate-800">Exam PDF</h2>
              </div>
              <div className="text-center">
                <p className="mb-4 text-slate-600">Due to copyright restrictions, we cannot host the PDF directly. Please use the button below to open the exam in a new tab.</p>
                <a
                  href={PDF_LINK}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block mb-4 w-full px-6 py-3 bg-indigo-600 text-white text-lg rounded-lg font-semibold shadow-md hover:bg-indigo-700 transition-transform transform hover:scale-105"
                >
                  Open Exam PDF
                </a>
                <a
                  href={ANSWER_KEY_LINK}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block w-full px-6 py-3 bg-gray-600 text-white text-lg rounded-lg font-semibold shadow-md hover:bg-gray-700 transition-transform transform hover:scale-105"
                >
                  Open Answer Explanations
                </a>
              </div>
            </div>
          )}
...
export default APUSHPracticeExamMCQMarco;
