...
const APGovArgumentativeEssaySelect: React.FC = () => {
  ...
  const handleSetClick = (setId: number) => {
    navigate(`/ap-gov-practice-exam/argumentative-essay/${setId}`);
  };
    ...
    <div className="min-h-screen py-16 px-4 bg-slate-50 flex items-center justify-center">
      <div className="w-full max-w-xl mx-auto flex flex-col items-center justify-center">
        ...
        <h1 className="text-3xl font-bold mb-8 text-center w-full text-red-700">
          Select AP Gov Argumentative Essay Set
        </h1>
        <div className="grid grid-cols-1 gap-6 w-full">
          {ARGUMENT_SETS.map((set) => (
            <button
              key={set.id}
...
export default APGovArgumentativeEssaySelect;
