...
const FRQ_CONTENT = {
  title: 'Collegeboard 2025 Scale Analysis Set 2',
  description: 'Answer all parts (A–G) of the following AP Human Geography Scale Analysis & Synthesis. Each part tests a different concept. Written responses are AI-graded.',
  pdf: '/APHUG-SA2.pdf',
};
...
const CRITERIA = [
  'A. Identifies the scale of analysis in Finland Map 2 (e.g., local, national, subnational, regional).',
  'B. Defines geometric boundaries (e.g., straight lines, follow latitude/longitude, not physical features).',
  'C. Describes a valid function of internal boundaries (e.g., political organization, voting, administration).',
  'D. Explains federal governance effect on spatial organization (e.g., autonomy of provinces/states, decentralization).',
  'E. Explains how EU membership may limit Finland\'s actions (e.g., policy restrictions, sovereignty limits).',
  'F. Describes cultural landscape feature tied to beliefs/identity (e.g., religious sites, language signs).',
  'G. Explains how communication tech affects indigenous languages (e.g., preservation, loss, revitalization, diffusion).',
];

const APHumanGeographyScaleAnalysisSet2 = () => {
...
export default APHumanGeographyScaleAnalysisSet2;
