...
const PDF_URL = `${import.meta.env.BASE_URL}APMacro-Exam3.pdf`;
...
const APMacroPracticeExamMCQ2010: React.FC = () => {
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-slate-100 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold text-blue-800 tracking-tight">AP Macroeconomics 2010 MCQ Practice Exam</h1>
        ...
        <div className="mt-8 w-full flex flex-col md:flex-row gap-8 justify-start items-start">
          ...
          <div className="flex-[3] min-w-[450px] max-w-5xl bg-white shadow-xl rounded-2xl flex flex-col items-center border border-slate-200">
            <div className="w-full p-4 bg-slate-50 rounded-t-2xl border-b border-slate-200">
                <h2 className="text-xl font-bold text-center text-blue-700">2010 AP Macroeconomics Practice Exam Document</h2>
            </div>
            <iframe
              src={PDF_URL}
              width="100%"
              height="900px"
              title="AP Macroeconomics 2010 Practice Exam PDF"
...
export default APMacroPracticeExamMCQ2010;
