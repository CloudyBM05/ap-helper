// This is the set selection page for AP Macro Long FRQ
...
const APMacroPracticeExamLongFRQ = () => {
      ...
      <div className="w-full max-w-xl mx-auto flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-1 gap-6 w-full">
          {frqSets.map((set) => (
            <button
              key={set.id}
              onClick={() => navigate(`/ap-macro-practice-exam/long-frq/${set.id}`)}
...
export default APMacroPracticeExamLongFRQ;
